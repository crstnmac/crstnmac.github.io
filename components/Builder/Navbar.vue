...
<template>
  <div
    ref="navbar"
    class="backdrop-filter backdrop-blur-md top-0 z-40 flex-none transition-colors duration-300 bg-white/[0.5] dark:bg-dark-900/[0.5]"
  >
    <div id="navbar-banner" class="banner">
      <slot name="banner" />
    </div>
    <div class="max-w-8xl w-full mx-auto">
      <div class="py-3 lg:px-5 mx-4 lg:mx-0">
