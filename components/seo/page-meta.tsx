...
const url: string = "https://crstnmac.github.io";

export default function PageMeta({ title, description, slug }: IPageMeta) {
  return (
    <>
      <title>{title ? `${title} » crstnmac.github.io` : site.seo.title}</title>
      <meta charSet="utf-8" />
      ...
      />
      <meta property="og:title" content={`${title} | crstnmac.github.io`} />
