        ...
        {posts?.length ? (
          <>
            {posts.map((b) => (
              <div
                key={b._id}
                className="group p-2 w-full sm:w-[330px] flex-none rounded-2xl  bg-gray-100 hover:bg-black-200 dark:bg-black-800 hover:dark:bg-black-600 transition duration-700 ease-in-out"
              >
                <Link
